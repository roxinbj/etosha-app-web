<template>
  ...
  <h3>Privacy Policy</h3>
    <p>Effective date: October 06, 2021</p>
    <p>Termite Software Close Corporation ("us", "we", or "our") operates the Etosha App mobile application (hereinafter referred to as the "Service").</p>
  ...
  <ul>
          <li> 
            <h6>Service</h6>
            <p>Service is the Etosha App mobile application operated by Termite Software Close Corporation</p>
            </li>
            <li> 
            <h6>Personal Data</h6>
    ...
    <h4>Use of Data</h4>
    <p>Termite Software Close Corporation uses the collected data for various purposes:</p>
    <ul>
    ...
    <p>If you are from the European Economic Area (EEA), Termite Software Close Corporation legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.</p>
    <p>Termite Software Close Corporation may process your Personal Data because:</p>
    <ul>
    ...
    <p>Termite Software Close Corporation will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes and enforce our legal agreements and policies.</p>
    <p>Termite Software Close Corporation will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of our Service, or we are legally obligated to retain this data for longer periods.</p>
    ...
    <p>Termite Software Close Corporation will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
 
    <h4>Disclosure of Data</h4>
    <h5>Disclosure for Law Enforcement</h5>
    <p>Under certain circumstances, Termite Software Close Corporation may be required to disclose your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
    <h5>Legal Requirements</h5>
    <p>Termite Software Close Corporation may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of Termite Software Close Corporation</li>
    ...
    <p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. Termite Software Close Corporation aims to take reasonable steps to allow you to correct, amend, delete or limit the use of your Personal Data.</p>
    ...
    <li>The right to withdraw consent. You also have the right to withdraw your consent at any time where Termite Software Close Corporation relied on your consent to process your personal information.</li>
    </ul>
    ...
    <ul>
    <li>Apple Store In-App Payments <a href="https://www.apple.com/legal/privacy/en-ww/">(Privacy Policy)</a></li>
    <li>Google Play In-App Payments <a href="https://policies.google.com/privacy">(Privacy Policy)</a></li>
    </ul>
    ...
    <ul>
    <li>By email: info@etosha-app.com</li>
    </ul>
  </div>
  <Footer />
</template>
